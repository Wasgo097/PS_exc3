...
// 
// gluPerspective(75.0, (double)szer/wys, 1.5, 1000.0); // przypisanie macierzy perspektywy do p/w transformacji
//
...
//}
//
//// pomocnicza procedura z definicja modelu graficznego ruchomej kostki 
//static void ModelKostka_()
//{
// glPushMatrix(); // zapamietanie globalnej macierzy dla p/w transformacji model-widok
// { 
//  glTranslatef(0.0f, 2.5f, 0.0f); // dolaczenie do p/w transformacji macierzy obrotow i przesuniecia dla p/n figury
//  glRotated(ruch.gama*180.0/M_PI, 0.0, 0.0, 1.0);
//  glRotated(ruch.beta*180.0/M_PI, 0.0, 1.0, 0.0);
//  glRotated(ruch.alfa*180.0/M_PI, 0.0, 0.0, 1.0);  
//  DefSzescian_(1.0,50,50); // definiowanie figury w srodku sceny
// }
// glPopMatrix(); // zresetowanie p/w transformacji model-widok do macierzy globalnej
//}
//
//// pomocnicza procedura z definicja modelu graficznego ruchomego wienca 
//static void ModelWieniec_()
//{
// glPushMatrix(); // zapamietanie globalnej macierzy dla p/w transformacji model-widok
// { 
//  glTranslatef(0.0f, 2.5f, 0.0f); // dolaczenie do p/w transformacji macierzy obrotow i przesuniecia dla p/n figury
//  glRotated(-(ruch.alfa+ruch.gama)*90.0/M_PI, 0.0, 0.0, 1.0);
//  glRotated(-(ruch.beta-ruch.alfa)*90.0/M_PI, 0.0, 1.0, 0.0);
//  DefTorus_(2.5,0.5,40,90); // definiowanie figury w srodku sceny
// }
// glPopMatrix(); // zresetowanie p/w transformacji model-widok do macierzy globalnej
//}
//
...
// static double tetp = 0.40, fp = 0.09, prmp = 1.00, psp = 0.25;
...
//{ return _losuj_(10); }
//bool Obliczenia() // kod symulacji opartej o rownanie Eulera-Langevina z sila stochastyczna i sila dyfuzyjna
//{
// static double tbieg = 0.0;
// static double omega1 = 0.0;
// static double omega2 = 0.0;
// static double omega3 = 0.0;
// static double tskok = 0.0;
// static double los1 = 1.0;
// static double los2 = 1.0;
// static double los3 = 1.0;
// const double energia = 1.5;
// const double opor = 0.05;
// const double delta = 0.03;
// const double tau = 0.15;
// 
// double sila = sqrt(4.0*energia*opor/(3.0*tau)); // implementacja rownania ruchu
// if (tbieg-tskok>tau) {
//  los1 = losuj_()-0.6;
//  los2 = losuj_()-0.4;
//  los3 = losuj_()-0.6;
//  tskok = tbieg;
// }  
// omega1 += (sila*los1-opor*omega1)*delta;
// omega2 += (sila*los2-opor*omega2)*delta;
// omega3 += (sila*los3-opor*omega3)*delta;
// tbieg += delta;
//
